$(function() {
	...
	function tooptipAppend(value) {
		if (savedSelection) {
			restoreSelection(document.getElementById("textarea"),
					savedSelection);
		}
	...
	$("#textarea").on("click", ".calorie", function(event) {
		event.preventDefault();
...
var savedSelection;
function doSave() {
	savedSelection = saveSelection(document.getElementById("textarea"));
